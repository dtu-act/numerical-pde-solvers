function compare_SEM_SEM(adjust, iter, xminmax, dx, fn_source, c, rho, ...\
        P1_order, P2_order, interface_order1, interface_order2, iface1, iface2, iloc)
    import setup.*
    ...
    analysis.run_compare(adjust, iter, sim1, sim2, "none", interface_order1, interface_order2, iloc);
end