function [p1,p2,sim1,sim2,iter] = run_FOURIER_FDTD(tmax, xminmax, x0_pos, dx1, dx2, fn_source, c, rho, scheme_order)
    import utilsDD.*
    import models.types.*
    import models.*
    ...
    sim2 = Simulation1D(SolverType.FDTD, domain2, {}, solvers.CustomFDTD(scheme_order));
