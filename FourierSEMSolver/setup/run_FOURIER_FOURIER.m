function [p1,p2,sim1,sim2,iter] = run_FOURIER_FOURIER(tmax, xminmax, dx1, dx2, fn_source, source_partition, x0_pos, c, rho, scheme_order)
    cfl = sqrt(3);    
    ...
    sim2 = Simulation1D(SolverType.FOURIER, domain2, src2, CustomFourier(nmodes2));
