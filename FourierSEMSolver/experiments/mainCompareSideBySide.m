...
switch compare_methods
    case "FDTD_FDTD"
        ...
        compare_FDTD_FDTD(adjust, iter, xminmax, dx, fn, c, rho, scheme1_order, scheme2_order, iloc)
    case "FOURIER_FOURIER"
        % "spatialAdjustment" | "temporalAdjustment" | "none"
        adjust = "none";
        
        compare_FOURIER_FOURIER(adjust, iter, xminmax, dx, nmodes, fn, c, rho, scheme1_order, scheme2_order, iloc)
    case "FOURIER_FDTD"
        % "spatialAdjustment" | "temporalAdjustment" | "none"
        adjust = "none";
        compare_FOURIER_FDTD(adjust, iter, xminmax, dx, nmodes, fn, c, rho, scheme1_order, scheme2_order, iloc)
    case "SEM_SEM"
        ...
        compare_SEM_SEM(iter, xminmax, dx, fn, c, rho, ...\
    ...
    case "SEM_FDTD"
        ...
        compare_SEM_FDTD(iter, xminmax, dx, fn, c, rho, ...\
