function [P, X, Y] = greensDirichletSpatial2D(Nx,Ny,lx,ly,M,Ps,k,tau,c)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%
    ...
    for nx = 0:Nx-1
        ...
        for ny = 0:Ny-1
            ...
            Psi_r = Lambda_m*sin(nx*pi*X/lx).*sin(ny*pi*Y/ly);
            Psi_r0 = Lambda_m*sin(nx*pi*x0/lx)*sin(ny*pi*y0/ly)*ones(length(ys), length(xs));
