...
%
%   Purpose : Compute (x,y) nodes in equilateral triangle for polynomial
%   of order N
%
    ...
    warpf1 = spectral.Warpfactor(N,L3-L2);
    warpf2 = spectral.Warpfactor(N,L1-L3);
    warpf3 = spectral.Warpfactor(N,L2-L1);
